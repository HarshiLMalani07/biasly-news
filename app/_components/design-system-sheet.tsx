...
import { Panel, Subhead } from "./panel";
...
/**
 * The Design System v1.0 reference sheet. Moved out of `app/page.tsx` when the
 * home feed took over the route; the panels themselves are unchanged.
 */
